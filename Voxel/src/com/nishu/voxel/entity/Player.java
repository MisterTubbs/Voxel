...
import com.nishu.voxel.math.CollisionLibrary;
...
public class Player extends Mob {
	...
	public void init() {
		box = new AABB(this.getPosition().x, this.getPosition().y, this.getPosition().z);
	}
	...
	public void render() {
		if(this.getRotation().x < -45) this.getRotation().setX(-45);
		if(this.getRotation().x > 45) this.getRotation().setX(45);
